Name:           ros-indigo-mrp2-common
Version:        0.2.3
Release:        0%{?dist}
Summary:        ROS mrp2_common package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/mrp2_common
Source0:        %{name}-%{version}.tar.gz

BuildArch:      noarch

Requires:       ros-indigo-mrp2-analyzer
Requires:       ros-indigo-mrp2-control
Requires:       ros-indigo-mrp2-description
Requires:       ros-indigo-mrp2-navigation
